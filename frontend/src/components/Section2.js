...
const Section2 = ({chat}) => {
  ...
  async function groupAdd() {
    ...
    try {
      ...
      const response = await axios.put(
        "https://chat-server-qvkq.onrender.com/chat/group-add",
        {
  ...
  async function groupRem() {
    ...
    try {
      ...
      const response = await axios.put(
        "https://chat-server-qvkq.onrender.com/chat/group-remove",
        {
  ...
  async function groupRename() {
    ...
    try {
      ...
      const response = await axios.put(
        "https://chat-server-qvkq.onrender.com/chat/rename",
        {
  ...
  async function changeAdmin(params) {
    ...
    try {
      ...
      const response = await axios.put(
        "https://chat-server-qvkq.onrender.com/chat/change-admin",
        {
  ...
  async function deleteGroup() {
    try {
      ...
      const response = await axios.delete(
        `https://chat-server-qvkq.onrender.com/chat/delete-group/${curChat._id}`,
        config)
